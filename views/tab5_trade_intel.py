...
"""
================================================================================
📁 views/tab5_trade_intel.py - 커피 무역 인텔리전스 허브
================================================================================
...
def show():
    ...
    st.markdown("<h1 style='text-align: center;'>커피 무역 인텔리전스</h1>", unsafe_allow_html=True)
    st.divider()
    ...
    # ===========================================
    with tab3:
        st.markdown(f"<h2 style='color:{COLOR_DEEP_COFFEE};'>🛡️ 통합 컴플라이언스 분석</h2>", unsafe_allow_html=True)
