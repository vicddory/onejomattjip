...
================================================================================
[리팩토링 v5] HTML 미리보기를 실제 문서 형태로 개선 (테이블 구조 적용)
================================================================================
"""
...
def show():
    ...
    with col3:
        ...
        selected_display = st.selectbox("산지 국가", country_options, key="proposal_country_display")
    ...
    lang_choice = st.radio("문서 언어 (Output Language)", ["한국어 (Korean)", "English"], horizontal=True, key="proposal_lang")
