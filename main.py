...
MENU_OPTIONS = {
    " 홈 (세계지도)": "landing",
    " 소싱 시그널": "tab1_sourcing",
    " 제안서 생성": "tab2_proposal",
    " 원가 계산기": "tab3_cost_calculator",
    " 뉴스 인사이트": "tab4_news",
    " 무역 인텔리전스": "tab5_trade_intel",
...
<div style="display: flex; align-items: center; justify-content: center; padding: 10px 0 5px 0;">
    ...
    <h2 style="color: #6F4E37; margin: 0; font-size: 1.5rem;">Coffee Trade Hub</h2>
    <span style="color: #666; font-size: 0.8rem; margin-left: 12px;">글로벌 원두 무역 플랫폼</span>
</div>
